<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\phpStudy\PHPTutorial\WWW\qiye/application/admin\view\recommend\add.html";i:1565597185;}*/ ?>
    ...
    <div class="page_right_style" style="width: 100%">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
            ...
            <div class="clearfix cl">
                ...
                <div class="formControls col-10">
                    <textarea name="feature" id="feature" style="width:100%; height:300px;"><?php echo $data['feature']; ?></textarea>
                </div>
            </div>

            <div class=" clearfix cl">
                <label class="form-label col-2">价格：</label>
                <div class="formControls col-10"><input type="text" class="input-text" value="<?php echo $data['price']; ?>" placeholder="例如:3.55" name="price"></div>
            </div>
