<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\PHPTutorial\WWW\qiye/application/admin\view\recommend\prolist.html";i:1565599980;}*/ ?>
...
<div class="clearfix">
    <div class="article_style" id="article_style">
       ...
       <span class="l_f">
        <a href="<?php echo url('add'); ?>?sid=<?php echo $sid; ?>" title="添加信息" id="add_page" class="btn btn-warning"><i class="fa fa-plus"></i> 新增推荐</a>
       </span>
            </div>
            <div class="article_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tr>
                        ...
                        <th align="center" width="500px">特征</th>
                    ...
                    <tr>
                        ...
                        <td><?php echo $v['feature']; ?></td>
                        <td><?php echo $v['price']; ?></td>
                        <td><?php echo getfalse($v['isfalse']); ?></td>
                        <td><?php echo $v['addtime']; ?></td>
                        <td class="td-manage">
                            <a title="编辑" href="<?php echo url('edit',['id'=>$v['id']]); ?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i>修改</a>
                            <a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo $v['id']; ?>')" class="btn btn-xs btn-danger" ><i class="fa fa-trash  bigger-120"></i>删除</a>
                        </td>
                    </tr>
