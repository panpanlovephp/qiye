<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\phpStudy\PHPTutorial\WWW\qiye/application/admin\view\recommend\index.html";i:1565593961;}*/ ?>
...
<div class="page-content clearfix">
    <div class="state-overview clearfix">
        ...
        <div class="col-lg-3 col-sm-6">
            <section class="panel">
                <a href="<?php echo url('Recommend/index'); ?>" title="<?php echo $vo['title']; ?>">
