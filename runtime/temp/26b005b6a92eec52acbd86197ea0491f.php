<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\phpStudy\PHPTutorial\WWW\qiye/application/admin\view\notice\add.html";i:1565924864;}*/ ?>
    ...
    <div class="page_right_style" style="width: 100%">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
            ...
            <div class="clearfix cl">
                ...
                <div class="formControls col-10">
                    <input type="text" class="input-text" value="<?php echo $data['label']; ?>" placeholder="请填写标签信息，每个标签之间用||分隔" name="label"></div>
            </div>
            <div class="clearfix cl">
            ...
            <div class="clearfix cl">
                ...
                <div class="formControls col-10"><input type="file" name="packImg"/></div>
            </div>
            <div class="clearfix cl">
            ...
            <div class="clearfix cl">
                ...
                <div class="formControls col-10" style="display:flex;white-space:nowrap;">
                    <input type="text" class="input-text" style="width:25%;margin-right:1%;" value="<?php echo $data['proItem']; ?>" placeholder="请填写标题" name="proItem">
                    <input type="text" class="input-text" style="width:25%;margin-right:1%;" value="<?php echo $data['proText']; ?>" placeholder="请填写信息" name="proText">
