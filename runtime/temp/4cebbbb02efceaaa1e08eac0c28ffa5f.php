...
<div class="clearfix">
    <div class="article_style" id="article_style">
       ...
       <span class="l_f">
        <a href="<?php echo url('add'); ?>?sid=<?php echo $sid; ?>" title="添加信息" id="add_page" class="btn btn-warning"><i class="fa fa-plus"></i> 添加信息</a>
       </span>
            </div>
            <div class="article_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo getQname($v['sid']); ?></td>
                        <td><?php echo $v['views']; ?></td>
                        <td><?php echo getfalse($v['isfalse']); ?></td>
                        <td><?php echo $v['addtime']; ?></td>
                        <td class="td-manage">
                            <a title="编辑" href="<?php echo url('edit',['id'=>$v['id'],'sid'=>$v['sid']]); ?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i>编辑</a>
